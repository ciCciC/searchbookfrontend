...
export class BaseMesh extends Mesh {
  ...
  //   const toReturn = new BaseMesh<Book>( geometry, material );
  ...
  // }
  //
  // static populateShape(meshOfBooks: Object3D, bookMeshList: BaseMesh<Book> []) {
  //   let i = 0;
  //   const count = 3;
  //
  ...
  //  */
  static populateAsRectangleShape(meshOfBooks: Object3D, bookMeshList: AmazonBookMesh [], preferredRowLength: number) {
  ...
  static populateAsRectangleShapeTest(meshOfBooks: Object3D, bookMeshList: AmazonBookMesh []) {
